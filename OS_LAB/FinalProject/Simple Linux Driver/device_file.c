...
MODULE_LICENSE("kernel_module");
MODULE_AUTHOR("yasaman mirmohammad <y.mirmohammad@yahoo.com>");
...
static ssize_t device_file_write(
                       ...
                       , loff_t *position)
{
    printk( KERN_NOTICE "Simple-driver: Device file is write at offset = %i, read bytes count = %u"
                , (int)*position
                , (unsigned int)count );
